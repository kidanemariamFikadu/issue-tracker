<div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : (localStorage.getItem('activeTab') || 'settings') }" 
    x-init="$watch('tab', value => { localStorage.setItem('activeTab', value); window.history.pushState(null, null, '#' + value); })" 
